    ...
    <div class="container">
      <div class="row">
        <div class="lead col-lg-12 col-xm-12 text-center">
          <h1><span class="top-heading-inner">Personal Development</span> </h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 text-left">
        <div class="pagenation_links"><a href="index.php">Home</a><i> / </i>Personal Development</div>
      </div>
...
<div id="about-us-in" class="text-center">
  <div class="container">
    <div class="section-title center">
      <div class="row">
        <div class="col-md-5"> <br><img src="img/group-of-businesspeople-working-and-making-hand-si-RF9JYMR.jpg" alt=""></div>
        <div class="col-md-6 text-left">
          ...
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting
            ...
            ever since the 1500s, when an unknown printer took a galley of type and
            scrambled it to make a type specimen book. </p>
          <a class="theme-btn btn-style-orange" href="getting_started.php">Get Started <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </a></div>
      </div>
    </div>
  </div>
</div>
