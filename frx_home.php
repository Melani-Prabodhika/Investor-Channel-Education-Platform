...
<div class="header" style="width: 100%; height: 25px; background-color: rgb(9, 37, 23); position: fixed; top: 0; left: 0;" >
    <a href="frx_login.html"><span>Logout</span></a>
</div>
</header>
    ...
    <div class="container">
      ...
      <div class="main">
        <form>
          ...
          <span><ul>
            <a href="#"><label>Forex English Academy</label></a>
            <a href="frx_sinhala.html"><label>Forex Sinhala Academy</label></a>
            <a href="#"><label>Forex Technical Analysis</label></a>
            <a href="#"><label>Forex Fundamental Analysis</label></a>
            <a href="#"><label>Forex Institutional Courses</label></a>
          </ul></span><br>
        </form>
      </div>
    </div>
